...
public class ValidationErrorHandler {
    ...
    public ValidationErrorsOutput handleValidationError(HttpMessageNotReadableException exception) {
    ...
    private ValidationErrorsOutput buildValidationErrors(List<ObjectError> globalErrors,
